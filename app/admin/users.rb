ActiveAdmin.register User do
  ...
  #
  permit_params :email, :encrypted_password, :reset_password_sent_at, :remember_created_at, :first_name, :last_name, :pseudo, :provider, :uid, :accepted, :lion, :xp, :job_title, :onboarded, :demo, :twitter, :linkedin
  #has_many :templates
  # or
  def name
    "#{pseudo}"
